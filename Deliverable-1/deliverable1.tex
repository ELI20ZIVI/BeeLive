...
L'obiettivo di questo progetto è di fornire una soluzione che dia la possibilità, ai cittadini di Trento, di visualizzare intuitivamente gli eventi che modificano la viabilità all'interno della città, in modo da capire facilmente se ci siano problemi o meno a seguire un percorso.\\
Questa soluzione si ripromette di informare attivamente gli utenti di eventuali eventi, nel caso in cui questi vadano a insorgere in zone direttamente interessate all'utente\\
