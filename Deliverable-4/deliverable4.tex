...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{| X | r | r | r | r |}
        ...
        \hline
        \makecell{Restituzione nuovo ID} & \makecell{} & \makecell{Creazione del sottocomponente\\che si occupa di restituire l'ID} & \makecell{Dennis Orlando} & \makecell{} \\
        \hline
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{| X | r | r | r | r |}
        ...
        \makecell{\textbf{Nome}} & \makecell{\textbf{User story}} & \makecell{\textbf{Cosa fare}} & \makecell{\textbf{Assegnazione}} & \makecell{\textbf{Stima}} \\
        \Xhline{2pt}
        \makecell{Implement event\\list page} & \makecell{} & \makecell{} & \makecell{Elia Ziviani} & \makecell{} \\
        \hline
        \makecell{Fetch eventi} & \makecell{} & \makecell{} & \makecell{} & \makecell{} \\
        \hline
    \end{tabularx}
    \caption{Product backlog 1}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{| X | r | r | r | r |}
        ...
        \makecell{\textbf{Nome}} & \makecell{\textbf{User story}} & \makecell{\textbf{Cosa fare}} & \makecell{\textbf{Assegnazione}} & \makecell{\textbf{Stima}} \\
        \Xhline{2pt}
        \makecell{Redirecting } & \makecell{} & \makecell{} & \makecell{} & \makecell{} \\
        \hline
        \makecell{} & \makecell{} & \makecell{} & \makecell{} & \makecell{} \\
        \hline
        \makecell{} & \makecell{} & \makecell{} & \makecell{} & \makecell{} \\
