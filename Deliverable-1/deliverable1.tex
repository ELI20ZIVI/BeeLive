...
La Municipalità di Trento, in collaborazione con l'Università, ha richiesto che come oggetto di valutzione del corso di "Ingegneria del Software" ideassimo un progetto a tema "Ideare la Trento del futuro".\\
...
\\
Questo documento è il primo "Deliberable" di 'BeeLive', i.e. il progetto da noi proposto per affrontare la suddetta consegna. \\
\\
Un primo processo di brainstorming ci ha permesso di notare come a Trento risulti difficile reperire informazioni riguardanti ad alcuni eventi, in particolare quelli che influenzano la viabilità stradale. Le informazioni disponibili sono principalmente testuali e richiedono un impegno attivo da parte dei cittadini per essere trovate.
...
\\
'BeeLive' è una soluzione che si pone come un affronto a questo problema. 


\section{Obiettivi e descrizione dell'applicativo}
\index{Obiettivi}

L'obiettivi che si ripropone questo applicativo è di risolvere i problemi precedentemente menzionati attraverso l'implementazione dei seguenti punti:\\
...
\subsubsection{L'utente autenticato non deve avere altri vantaggi rispetto l'utente non autenticato}
