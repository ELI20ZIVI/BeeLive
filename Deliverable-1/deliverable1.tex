...
\subsection{Visualizzazione dettagli evento}
...
\subsection{Definizione categorie}
...
\subsection{Definizione zone di interesse}
...
\section{Domande da fare}
\index{Domande da fare}
\begin{enumerate}
    \item BPMN rappresentazione websocket
\end{enumerate}
