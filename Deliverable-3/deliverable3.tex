...
Per lo sviluppo dell'applicativo è stato evitato l'approccio "Master only" in quanto può causare problemi di collaborazione e conflitti quando più membri del team lavorano contemporaneamente sullo stesso branch.\\
Infatti questo approccio prevede la creazione e l'utilizzo di un unico branch principale, chiamato "main", su cui tutti i membri del team lavorano.\\
Per aumentare la modulabilità e la scalabilità del progetto, abbiamo adottato una strategia di branching che prevede la creazione di un branch separato per ogni specifico modulo del progetto.\\
Il merge dal branch specifico del modulo al branch principale avviene solamete quando il modulo rispetta tutti i punti della "Definition of Done" definita dal team.\\
Tramite questo approccio è possibile incrementare la collaborazione tra i membri del team, ridurre i conflitti e le inconsistenze nel codice, facilitando la gestione delle diverse attività in corso.\\
E' possibile inoltre mappare tutte le diverse modifiche e progressi del progetto, mantenendo ben strutturata la storia del codice.\\

Segue una lista dei branch utilizzati per lo sviluppo del progetto:
