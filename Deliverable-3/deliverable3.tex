...
\begin{table}[htbp]
    \centering
    \renewcommand{\arraystretch}{1.3} % Imposta lo spazio verticale delle righe
    \begin{tabularx}{\textwidth}{| r | X | r | r | r | r | r | r |}
        \Xhline{2pt}
        \makecell{\textbf{Numero}} & \makecell{\textbf{Dati}} & \makecell{\textbf{Precondizioni}} & \makecell{\textbf{Dipendenze}} & \makecell{\textbf{Risultati attesi}} & \makecell{\textbf{Risultati ottenuti}} & \makecell{\textbf{Note}} \\
        \Xhline{2pt}
        \hline
    \end{tabularx}
    \caption{Product backlog user story 5}
