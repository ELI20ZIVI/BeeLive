...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{| X | r | r | r | r |}
        ...
        \Xhline{2pt}
        \makecell{Sistemazione\\codici di errore\\del public server} & \makecell{} & \makecell{Nello sprint precedente erano\\stati definiti in modo poco chiaro\\alcuni codici di errore, che quindi\\vanno ridefiniti} & \makecell{Elia Ziviani} & \makecell{} \\
        \hline
        \makecell{Creazione\\dei test} & \makecell{} & \makecell{Creazione dei test sulla\\base dei nuoi codici di\\errore per verificare l'effettivo\\funzionamento del componente} & \makecell{Elia Ziviani} & \makecell{} \\
        \hline
    \end{tabularx}
    \caption{Product backlog}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{| X | r | r | r | r |}
        ...
        \hline
        \makecell{Sistemazione\\codici di errore\\(Management Server)} & \makecell{} & \makecell{Nello sprint precedente erano\\stati definiti in modo poco chiaro\\alcuni codici di errore, che quindi\\vanno ridefiniti} & \makecell{Dennis Orlando} & \makecell{} \\
        \hline
        ...
        \hline
        \makecell{Redirecting alla\\pagina degli eventi\\dopo il publish} & \makecell{} & \makecell{Creazione logica di redirecting\\alla pagina degli eventi dopo\\la creazione di un evento nuovo} & \makecell{Dennis Orlando} & \makecell{} \\
        \hline
        \makecell{No empty multipolygon\\when processing an\\Event with no SubEvents\\with polygons} & \makecell{} & \makecell{...} & \makecell{Dennis Orlando} & \makecell{} \\
        \hline
    \end{tabularx}
    \caption{Product backlog}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{| X | r | r | r | r |}
        ...
        \makecell{\textbf{Nome}} & \makecell{\textbf{User story}} & \makecell{\textbf{Cosa fare}} & \makecell{\textbf{Assegnazione}} & \makecell{\textbf{Stima}} \\
        \Xhline{2pt}
        \makecell{Token validation} & \makecell{} & \makecell{Creazione della logica di\\validazione del toke ricevuto} & \makecell{Pietro Cipriani} & \makecell{} \\
        \hline
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{| X | r | r | r | r |}
        ...
        \makecell{\textbf{Nome}} & \makecell{\textbf{User story}} & \makecell{\textbf{Cosa fare}} & \makecell{\textbf{Assegnazione}} & \makecell{\textbf{Stima}} \\
        \Xhline{2pt}
        \makecell{Fix mobile\\application\\map} & \makecell{} & \makecell{Ridefinizione delle caratteristiche\\del modulo di mappa incluso\\nell'applicativo mobile} & \makecell{} & \makecell{} \\
        \hline
        \makecell{Refactoring} & \makecell{} & \makecell{Controllo, aggiornamento e\\miglioramento del codice} & \makecell{} & \makecell{} \\
        \hline
    \end{tabularx}
    \caption{Product backlog}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{| X | r | r | r | r |}
        ...
        \makecell{\textbf{Nome}} & \makecell{\textbf{User story}} & \makecell{\textbf{Cosa fare}} & \makecell{\textbf{Assegnazione}} & \makecell{\textbf{Stima}} \\
        \Xhline{2pt}
        \makecell{Details page} & \makecell{} & \makecell{Ricomposizione della pagina che\\mostra i dettagli di ongi evento\\(Mappa e sottoeventi)} & \makecell{Elia Ziviani} & \makecell{} \\
        \hline
        \makecell{Details client} & \makecell{} & \makecell{} & \makecell{Pietro Cipriani} & \makecell{} \\
        \hline
    \end{tabularx}
    \caption{Product backlog}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{| X | r | r | r | r |}
        ...
        \makecell{\textbf{Nome}} & \makecell{\textbf{User story}} & \makecell{\textbf{Cosa fare}} & \makecell{\textbf{Assegnazione}} & \makecell{\textbf{Stima}} \\
        \Xhline{2pt}
        \makecell{Redirecting\\alla pagina\\di modifica} & \makecell{} & \makecell{Sviluppo della logica di\\rimando alla pagina di modifica\\dell'evento e sviluppo della\\pagina stessa} & \makecell{Dennis Orlando} & \makecell{} \\
        \hline
        \makecell{Endpoint:\\Modifica} & \makecell{} & \makecell{Sviluppo dell'endpoint che\\si occupa della modifica di\\un evento selezionato} & \makecell{Elia Ziviani} & \makecell{} \\
        \hline
        \makecell{DAO:\\Modifica} & \makecell{} & \makecell{Sviluppo del modulo che\\si occupa della modifica\\dell'evento agendo direttamente\\sui dati del database} & \makecell{Elia Ziviani} & \makecell{} \\
        \hline
        \makecell{Event Manager:\\Modifica} & \makecell{} & \makecell{Sviluppo del modulo che\\si occupa di gestire le richieste di\\modifica degli eventi fatte\\al management server} & \makecell{Elia Ziviani} & \makecell{} \\
        \hline
    \end{tabularx}
    \caption{Product backlog}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{| X | r | r | r | r |}
        ...
        \makecell{\textbf{Nome}} & \makecell{\textbf{User story}} & \makecell{\textbf{Cosa fare}} & \makecell{\textbf{Assegnazione}} & \makecell{\textbf{Stima}} \\
        \Xhline{2pt}
        \makecell{Pulsante di\\eliminazione nella\\pagina di modifica} & \makecell{} & \makecell{Aggiunta di un pulsante che\\permette l'eliminazione degli\\eventi nella pagina di modifica} & \makecell{Dennis Orlando} & \makecell{} \\
        \hline
        \makecell{Dialog di\\conferma} & \makecell{} & \makecell{Creazione di un dialog di\\conferma dell'operazione che si\\vuole portare a termine} & \makecell{Dennis Orlando} & \makecell{} \\
        \hline
        \makecell{Endpoint:\\Eliminazione} & \makecell{} & \makecell{Sviluppo dell'endpoint che\\si occupa dell'eliminazione di\\un evento selezionato} & \makecell{Elia Ziviani} & \makecell{} \\
        \hline
        \makecell{DAO:\\Eliminazione} & \makecell{} & \makecell{Sviluppo del modulo che\\si occupa dell'eliminazione\\dell'evento agendo direttamente\\sui dati del database} & \makecell{Elia Ziviani} & \makecell{} \\
        \hline
        \makecell{Event Manager:\\Eliminazione} & \makecell{} & \makecell{Sviluppo del modulo che\\si occupa di gestire le richieste di\\eliminazione degli eventi fatte\\al management server} & \makecell{Elia Ziviani} & \makecell{} \\
        \hline
    \end{tabularx}
    \caption{Product backlog}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|r|X|X|X|X|X|}
        ...
        \makecell{\textbf{No.}} & \makecell{\textbf{Descrizione}} & \makecell{\textbf{Dati}} & \makecell{\textbf{Precondizioni}} & \makecell{\textbf{Risultati attesi}} & \makecell{\textbf{Note}} \\
        \Xhline{2pt}
        1 & Test \texttt{list\_events} senza token di autenticazione & Richiesta GET a \texttt{/list\_events} senza header di autorizzazione & Applicazione inizializzata & Stato della risposta: 401 Unauthorized & \\
        \hline
        2 & Test \texttt{list\_events} con utente non autorizzato & Richiesta GET a \texttt{/list\_events} con token non autorizzato & Applicazione inizializzata & Stato della risposta: 403 Forbidden & \\
        \hline
        3 & Test \texttt{list\_events} con pagina negativa & Richiesta GET a \texttt{/list\_events?page=-2} con token valido & Applicazione inizializzata con un utente autorizzato all'operazione & Stato della risposta: 422 Unprocessable Entity & \\
        \hline
        4 & Test \texttt{list\_events} con pagina valida & Richiesta GET a \texttt{/list\_events?page=2} con token valido & Applicazione inizializzata con utente autorizzato all'operazione & Stato della risposta: 200 OK & \\
        \hline
    \end{tabularx}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{| r | X | X | X | X | X |}
        ...
        \makecell{\textbf{No.}} & \makecell{\textbf{Descrizione}} & \makecell{\textbf{Dati}} & \makecell{\textbf{Precondizioni}} & \makecell{\textbf{Risultati attesi}} & \makecell{\textbf{Note}} \\
        \Xhline{2pt}
        1 & Test \texttt{insert\_event} con un evento valido & Richiesta PUT a \texttt{insert\_event} con JSON dell'evento valido e user token di utente autorizzato nel body & Applicazione inizializzata con l'utente autorizzato all'inserzione  & Stato della risposta: 201 Created & \\
        \hline
        2 & Test \texttt{insert\_event} di un evento con body non processabile & Richiesta PUT a \texttt{insert\_event} con JSON dell'evento non processabile e user token di utente autorizzato nel body & Applicazione inizializzata con l'utente autorizzato all'inserzione & Stato della risposta: 400 Bad Request & \\
        \hline
        3 & Test \texttt{insert\_event} di un evento senza token di autenticazione & Richiesta PUT a \texttt{insert\_event} senza il user token nel body & Applicazione inizializzata & Stato della risposta: 401 Unauthorized & \\
        \hline
        4 & Test \texttt{insert\_event} di un evento con utente non autorizzato & Richiesta PUT a \texttt{insert\_event} con l'user token di un utente non autorizzato nel body & Applicazione inizializzata con l'utente non autorizzato all'inserzione & Stato della risposta: 403 Forbidden & \\
        \hline
        5 & Test \texttt{insert\_event} di un evento con body non valido & Richiesta PUT a \texttt{insert\_event} con JSON dell'evento non valido e user token di utente autorizzato nel body & Applicazione inizializzata & Stato della risposta: 422 Unprocessable Entity & \\
        \Xhline{2pt}
    \end{tabularx}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{| r | X | X | X | X | X | X |}
        ...
        \makecell{\textbf{No.}} & \makecell{\textbf{Descrizione}} & \makecell{\textbf{Dati}} & \makecell{\textbf{Precondizioni}} & \makecell{\textbf{Risultati attesi}} & \makecell{\textbf{Note}} \\
        \Xhline{2pt}
        1 & Test \texttt{delete\_event} con evento esistente & Richiesta DELETE a \texttt{/delete\_event/0} con header di autorizzazione valido & Evento con id 0 esiste & Stato della risposta 200 OK & \\
        \hline
        2 & Test \texttt{delete\_event} senza token di autenticazione & Richiesta DELETE a \texttt{/delete\_event/0} senza header di autorizzazione & Nessuna & Stato della risposta 401 Unauthorized & \\
        \hline
        3 & Test \texttt{delete\_event} con utente non autorizzato & Richiesta DELETE a \texttt{/delete\_event/0} con header di autorizzazione non valido & Nessuna & Stato della risposta 403 Forbidden & \\
        \hline
        4 & Test \texttt{delete\_event} con evento non esistente & Richiesta DELETE a \texttt{/delete\_event/1} con header di autorizzazione valido & Evento con id 1 non esiste & Stato della risposta 404 Not Found & \\
        \hline
        5 & Test \texttt{delete\_event} con evento non bloccato dall'utente & Richiesta DELETE a \texttt{/delete\_event/0} con header di autorizzazione valido & Evento con id 0 non bloccato dall'utente & Stato della risposta 418 I'm a teapot & \\
        \hline
        6 & Test \texttt{delete\_event} con evento bloccato da un altro utente & Richiesta DELETE a \texttt{/delete\_event/0} con header di autorizzazione valido & Evento con id 0 bloccato da un altro utente & Stato della risposta 423 Locked & Non implementato \\
        \hline
    \end{tabularx}
\end{table}
...
\begin{table}[htbp]
    ...
    \makecell{\textbf{No.}} & \makecell{\textbf{Descrizione}} & \makecell{\textbf{Dati}} & \makecell{\textbf{Precondizioni}} & \makecell{\textbf{Risultati attesi}} & \makecell{\textbf{Note}} \\ 
    \Xhline{2pt}
    1 & Test \texttt{modify\_event} con evento esistente & Evento valido e user token autorizzato nel body & Evento esistente con ID 0 & 200 OK &  \\ 
    \hline
    2 & Test \texttt{modify\_event} senza token di autenticazione & Evento valido nel body & Nessun token fornito & 401 Unauthorized &  \\ 
    \hline
    3 & Test \texttt{modify\_event} con utente non autorizzato & Evento valido e user token di utente non autorizzato nel body  & Utente non autorizzato & 403 Forbidden &  \\ 
    \hline
    4 & Test \texttt{modify\_event} su evento non esistente & Evento nel body con ID non esistente & Evento con ID 1 non esistente & 404 Not Found &  \\ 
    \hline
    5 & Test \texttt{modify\_event} ma in conflitto di modifiche simultanee & Evento valido nel body & Evento già modificato da un'altra sessione & 409 Conflict &  \\ 
    \Xhline{2pt}
    \end{tabularx}
