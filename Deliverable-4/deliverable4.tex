...
\subsubsection{Attività relative alla user story "Accesso alle criticità e ai loro dettagli"}
...
\subsubsection{Tasks riguardanti la gestione degli eventi sul programma desktop}
...
\end{table}
\clearpage
\subsubsection{Attività relative all'accesso utente all'applicativo desktop}
\vspace{-0.3cm}
\begin{table}[H]
    \centering
    \renewcommand{\arraystretch}{1.3} % Imposta lo spazio verticale delle righe
...
\end{table}
\vspace{0.5cm}
\subsubsection{Operazioni di ridefinizione e miglioramento del codice relativo all'applicativo mobile}
\vspace{-0.3cm}
\begin{table}[H]
    \centering
    \renewcommand{\arraystretch}{1.3} % Imposta lo spazio verticale delle righe
...
\subsubsection{Tasks riguardanti la gestione visualizzazione dei dettagli degli eventi sull'applicativo mobile}
\vspace{-0.3cm}
\begin{table}[H]
    \centering
    \renewcommand{\arraystretch}{1.3} % Imposta lo spazio verticale delle righe
...
\end{table}
\vspace{0.5cm}
\subsubsection{Attività di ottenimento e visualizzazione delle criticità sull'applicativo desktop}
\vspace{-0.3cm}
\begin{table}[H]
    \centering
    \renewcommand{\arraystretch}{1.3} % Imposta lo spazio verticale delle righe
...
\clearpage
\subsubsection{Tasks riguardanti la gestione del processo di modifica di un evento sull'applicativo desktop}
\vspace{-0.3cm}
\begin{table}[H]
    \centering
    \renewcommand{\arraystretch}{1.3} % Imposta lo spazio verticale delle righe
...
\subsubsection{Tasks riguardanti la gestione del processo di eliminazione di un evento sull'applicativo desktop}
\vspace{-0.3cm}
\begin{table}[H]
    \centering
    \renewcommand{\arraystretch}{1.3} % Imposta lo spazio verticale delle righe
