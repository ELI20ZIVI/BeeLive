...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{|X|X|X|X|X|}
        ...
        \Xhline{2pt} % Linea spessa
        Visualizzazione degli eventi: \ref{Visualizzazione degli eventi} & \ref{3.1.1}\newline\ref{3.1.2} & \ref{8.2.1}\newline\ref{8.2.2} & \ref{5.1.1}\newline\ref{5.1.2}\newline\ref{5.1.3}\newline\ref{5.1.4}\newline\ref{5.1.7} & \ref{4.1.1}\newline\ref{4.1.2} \\
        \hline
        Accesso alle notifiche: \ref{Accesso alle notizie} & \ref{3.1.1}\newline\ref{3.1.2} & \ref{8.2.1}\newline\ref{8.2.3} & \ref{5.1.10} & \ref{4.1.3} \\
        \hline
        Scelta percorsi significativi: \ref{Percorsi abituali} & \ref{3.1.1}\newline\ref{3.1.2} & \ref{8.2.4}\newline\ref{8.2.5} & \ref{5.1.8}\newline\ref{5.1.9} & - \\
        \hline
        Gestione degli Eventi: \ref{Gestione degli eventi} & \ref{3.1.3}\newline\ref{3.2.1} & \ref{8.3.1}\newline\ref{8.3.2}\newline\ref{8.3.3}\newline\ref{8.3.4} & \ref{5.3.2}\newline\ref{5.3.3}\newline\ref{5.3.5}\newline\ref{5.3.6}\newline\ref{5.3.7}\newline\ref{5.3.8}\newline\ref{5.3.9}\newline\ref{5.3.10} & \ref{4.2} \\
        \hline
    \end{tabularx}
