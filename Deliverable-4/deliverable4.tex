...
\noindent
Come specificato in seguito, il deployment è stato eseguito su server personale. Visto lo scope del progetto non è stato ritenuto opportuno perdere tempo nell'implementare meccanismi automatici CICD.\\\\
...
Come tecnologia di containerizzazione è stato scelto Docker, in quanto permette di creare, distribuire e gestire applicazioni in container in modo semplice e veloce. In questo contesto, la semplicità di utilizzo e la mancanza di esigenze particolari non ha reso opportuno l'utilizzo di orchestratori quali Kubernetes.\\
...
\begin{itemize}
    \item \textbf{Applicativo desktop}: Sistema operativo Linux % Non so se lo facciamo girare altrove
...
in caso di deployment in locale risulta necessario assicurarsi della raggiungibilità della macchina che esegue i webserver da parte del dispositivo che esegue la mobile app.
