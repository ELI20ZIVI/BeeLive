...
\subsection{Diagramma dei componenti di notifica}
...
\begin{figure}[htbp]
    ...
    \caption{Diagramma dei componenti di notifica}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{| l | l | X |}
        ...
        \Xhline{2pt}
         & Token validation & Il componente utilizza l'interfaccia fornita dal componente "Authentication SDK" per la verifica e validazione del token di autenticazione. \\
        \hline
         & Register listener & Il componente utilizza l'interfaccia fornita dal componente "Core" per ricevere le notifiche relative agli eventi. \\
        \Xhline{2pt}
        \textbf{OUTPUT} & \textbf{Nome} & \textbf{Descrizione} \\
        \Xhline{2pt}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{| l | l | X |}
        ...
        \textbf{INPUT} & \textbf{Nome} & \textbf{Descrizione} \\
        \Xhline{2pt}
         & User categories & Il componente utilizza l'interfaccia fornita dal componente DAO per ottenere tutte le categorie impostate dagli utenti. \\
        \Xhline{2pt}
        \textbf{OUTPUT} & \textbf{Nome} & \textbf{Descrizione} \\
        \Xhline{2pt}
         & Event modification & Il componente fornisce un'interfaccia per notificare le modifiche agli eventi. \\
        \hline
         & Register listener & Il componente fornisce un'interfaccia per aprire un canale sulla quale inviare le notifiche. \\
        \hline
    \end{tabularx}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{| l | l | X |}
        ...
        \textbf{INPUT} & \textbf{Nome} & \textbf{Descrizione} \\
        \Xhline{2pt}
         & OpenRouteService & Il componente utilizza un'interfaccia esterna per eseguire il calcolo del percorso richiesto dall'utente che evita le criticità su mappa. \\
        \Xhline{2pt}
        \textbf{OUTPUT} & \textbf{Nome} & \textbf{Descrizione} \\
        \Xhline{2pt}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{| l | l | X |}
        ...
        \textbf{INPUT} & \textbf{Nome} & \textbf{Descrizione} \\
        \Xhline{2pt}
         & Event & Il componente utilizza l'interfaccia fornita dal componente "Event Proessor" per ottenere gli eventi processati dal sistema. \\
        \hline
         & Preferences & Il componente utilizza l'interfaccia fornita dal componente "Preferences manager" per ottenere le preferenze impostate dagli utenti. \\
        \Xhline{2pt}
        \textbf{OUTPUT} & \textbf{Nome} & \textbf{Descrizione} \\
        \Xhline{2pt}
         & Web API & Il componente fornisce un'interfaccia per permettere l'utilizzo delle API agli applicativi coinvolti nel sistema. \\
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{| l | l | X |}
        ...
        \textbf{INPUT} & \textbf{Nome} & \textbf{Descrizione} \\
        \Xhline{2pt}
         & Event & Il componente utilizza l'interfaccia fornita dal componente "DAO" per ottenere gli eventi presenti nel sistema. \\
        \Xhline{2pt}
        \textbf{OUTPUT} & \textbf{Nome} & \textbf{Descrizione} \\
        \Xhline{2pt}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{| l | l | X |}
        ...
        \textbf{INPUT} & \textbf{Nome} & \textbf{Descrizione} \\
        \Xhline{2pt}
         & Preferences & Il componente utilizza l'interfaccia fornita dal componente "DAO" per ottenere le preferenze impostate dagli utenti. \\
        \Xhline{2pt}
        \textbf{OUTPUT} & \textbf{Nome} & \textbf{Descrizione} \\
        \Xhline{2pt}
         & Preferences & Il componente fornisce un'interfaccia per ottenere le preferenze impostate dagli utenti. \\
        \hline
    \end{tabularx}
    \caption{Tabella Preference Manager}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{| l | l | X |}
        ...
        \textbf{INPUT} & \textbf{Nome} & \textbf{Descrizione} \\
        \Xhline{2pt}
         & Query & Il componente utilizza l'interfaccia esterna per ottenere le query da eseguire sul database. \\
        \Xhline{2pt}
        \textbf{OUTPUT} & \textbf{Nome} & \textbf{Descrizione} \\
        \Xhline{2pt}
         & Event & Il componente fornisce un'interfaccia per fornire gli eventi processati. \\
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{| l | l | X |}
        ...
        \hline
         & Event modification & Il componente utilizza l'interfaccia fornita dal componente "Event processor" per processare un evento. \\
        \hline
        ...
        \hline
         & Events & Il componente utilizza l'interfaccia fornita dal componente "DAO" per reperire tutti gli eventi a sistema. \\
        \Xhline{2pt}
        \textbf{OUTPUT} & \textbf{Nome} & \textbf{Descrizione} \\
        \Xhline{2pt}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{| l | l | X |}
        ...
        \textbf{INPUT} & \textbf{Nome} & \textbf{Descrizione} \\
        \Xhline{2pt}
         & Query & Il componente utilizza un'interfaccia esterna per ottenere le queryes da eseguire. \\
        \Xhline{2pt}
        \textbf{OUTPUT} & \textbf{Nome} & \textbf{Descrizione} \\
        \Xhline{2pt}
         & Save log & Il componente fornisce un'interfaccia per permettere il salvataggio del log di tutti gli eventi. \\
        \hline
         & Events & Il componente fornisce un'interfaccia per permettere l'accesso a tutti gli eventi presenti nel sistema. \\
        \hline
    \end{tabularx}
    \caption{Tabella DAO}
\end{table}
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{| l | l | X |}
        ...
        \textbf{INPUT} & \textbf{Nome} & \textbf{Descrizione} \\
        \Xhline{2pt}
         & Lock & Il componente utilizza l'interfaccia fornita dal componente "Locker" per permettere la mutua esclusione ad un evento. \\
        \hline
         & Log & Il componente utilizza l'interfaccia fornita dal componente "Logger" per il salvataggio dello storico di tutte le operazioni effettuate. \\
        \hline
         & List & Il componente utilizza l'interfaccia fornita dal componente "Event manager" per reperire tutti gli eventi a sistema. \\
        \hline
         & Manage & Il componente utilizza l'interfaccia fornita dal componente "Event manager" per permettere la gestione degli eventi. \\
        \hline
         & Parse & Il componente utilizza l'interfaccia fornita dal componente "Custom event parser" per eseguire il parsing dei dati. \\
        \hline
...
\begin{table}[htbp]
    ...
    \begin{tabularx}{\textwidth}{| l | l | X |}
        ...
        \textbf{INPUT} & \textbf{Nome} & \textbf{Descrizione} \\
        \Xhline{2pt}
         & Save log & Il componente utilizza l'interfaccia fornita dal componente "DAO" per salvare il log di tutti gli eventi. \\
        \Xhline{2pt}
        \textbf{OUTPUT} & \textbf{Nome} & \textbf{Descrizione} \\
        \Xhline{2pt}
