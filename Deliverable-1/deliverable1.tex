...
Deve poter indicare categorie di interesse in maniera indipendente per eventi in zone di interesse (Aree e percorsi) e non.
...
\index{Deve poter gestire gli eventi che non sono di sua competenza}
